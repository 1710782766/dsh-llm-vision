...
const REF = '![图片](/llm-vision/raw/sha256:abc)'
/** The raw-route path inside {@link REF}. */
const PATH = '/llm-vision/raw/sha256:abc'
...
describe('findImageReferences', () => {
  ...
  it('ignores plain links and absolute-URL forms', () => {
    expect(findImageReferences('[图片](/llm-vision/raw/sha256:abc)')).toEqual([])
    expect(findImageReferences('![图片](http://127.0.0.1:3080/llm-vision/raw/sha256:abc)')).toEqual([])
  })
})
